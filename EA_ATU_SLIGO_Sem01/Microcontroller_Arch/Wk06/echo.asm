...
main:
	movlb 01H	
	bsf TRISC,4	;S1 pin input
	bcf TRISA,5	;D4 pin output
	movlb 03H	
	bcf ANSELC,4	;S1 pin digital
	bcf ANSELA,5	;D4 pin digital
	movlb 00H
LOOP:
	lslf PORTC,0	;Read status of S1
	movwf PORTA	;Write status of S1 to D4
	goto    LOOP		
	END resetVec
